...
-- 1. Rata-Rata Kalori Terbakar Berdasarkan Gender
SELECT 
    Gender, 
...
-- 2. Jenis Latihan Terpopuler Berdasarkan Jumlah Member
SELECT 
    `Workout_Type`, 
...
-- 3. Rata-Rata BPM dan Durasi Latihan untuk Member Aktif (> 3 hari/minggu)
SELECT 
...
-- 4. Rata-Rata Persentase Lemak Berdasarkan Gender untuk Member Berat > 70 kg
SELECT 
    Gender, 
...
-- 5. Tren Jenis Latihan dan Rata-Rata Resting BPM untuk Member Muda (< 25 Tahun)
SELECT 
    `Workout_Type`,
